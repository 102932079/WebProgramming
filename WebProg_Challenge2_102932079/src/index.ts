...
let Quiz1 = new Quiz("1. What is the rarest blood type?", "a)O", "b)A", "c)B", "d)AB",4);
...
let Quiz2 = new Quiz("2. How many bones are there in the human body?", "a)206", "b)205", "c)201", "d)209",1);
let Package2 = new Package(Quiz2);
Package2.spawn(display);

let Quiz3 = new Quiz("3. Fe is the chemical symbol for…", "a)Zinc", "b)Hydrogen", "c)Fluorine", "d)Iron",4);
let Package3 = new Package(Quiz3);
Package3.spawn(display);

let Quiz4 = new Quiz("4. Which planet in our solar system is the largest?", "a)Jupiter", "b)Saturn", "c)Neptune", "d)Earth",4);
let Package4 = new Package(Quiz4);
Package4.spawn(display);

let Quiz5 = new Quiz("5. Which ocean is the largest?", "a)Indian", "b)Pacific", "c)Atlantic", "d)Arctic",2);
